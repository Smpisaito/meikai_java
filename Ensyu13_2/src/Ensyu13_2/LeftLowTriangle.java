 ...
 * 作成日：2023.05.10
 */
public class LeftLowTriangle extends TriangleShape {

	// コンストラクト
	public LeftLowTriangle (int triangleLength) {
		// 二等辺の辺の長さをいれる
	...
	public String toString() {
		...
		return "直角二等辺三角形(二等辺の長さ：" + super.getTriangleLength() + ",直角の位置：左下)";
	}
	
	/*
	 * 関数名：drawShape
	 * 概要：左下が直角の直角二等辺三角形をつくる。
	 * 引数：なし
	 * 戻り値：なし
	 * 作成者：S.Saito
	 * 作成日：2023.05.10
